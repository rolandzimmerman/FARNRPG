...
function scr_BuildCharacterDB() {
    ...
    // Default FX (Use your actual assets or keep spr_pow/snd_punch for now)
    ...
    ds_map_add(_char_map, "hero", {
        ...
        skills: [ 
             // animation_type defaults to "magic" if omitted
            ...
            { name: "Fireball", cost: 6, effect: "damage_enemy", target_type: "enemy", damage: 18, element: "fire", power_stat: "matk", fx_sprite: spr_fx_fireball ?? default_damage_fx, fx_sound: snd_sfx_fire ?? default_damage_snd }, 
        ...
        cast_sprite: spr_player_cast // <<< ADDED
    });
    ...
    ds_map_add(_char_map, "claude", {
        ...
        cast_sprite: spr_claude_cast // <<< ADDED
    });
    ...
    ds_map_add(_char_map, "gabby", {
        ...
        cast_sprite: spr_gabby_cast // <<< ADDED
    });
    ...
    ds_map_add(_char_map, "izzy", {
        ...
        level: 1, xp: 0, xp_require: 100, overdrive: 0, overdrive_max: 100, 
        skills: [ 
            { name: "Steal", cost: 0, effect: "steal_item", target_type: "enemy", animation_type: "physical", fx_sprite: default_status_fx, fx_sound: default_status_snd }, // <<< Uses physical animation
            { name: "Quick Attack", cost: 3, effect: "damage_enemy", target_type: "enemy", damage: 10, element: "physical", power_stat: "atk", animation_type: "physical", fx_sprite: default_slash_fx, fx_sound: snd_punch }, // <<< Uses physical animation
        ], 
        ...
        cast_sprite: spr_izzy_cast // <<< ADDED (Or maybe same as attack?)
    });
