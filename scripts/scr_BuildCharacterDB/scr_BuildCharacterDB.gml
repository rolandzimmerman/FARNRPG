...
function scr_BuildCharacterDB() {
    ...
    var default_heal_fx = spr_fx_heal ?? spr_pow; var default_heal_snd = snd_sfx_heal ?? snd_punch;
    var default_damage_fx = spr_fx_zap ?? spr_pow; var default_damage_snd = snd_sfx_zap ?? snd_punch;
    var default_status_fx = spr_fx_status ?? spr_pow; var default_status_snd = snd_sfx_status ?? snd_punch;
    var default_overdrive_fx = spr_fx_overdrive ?? spr_pow; var default_overdrive_snd = snd_sfx_overdrive ?? snd_punch;
    ...
    ds_map_add(_char_map, "hero", {
        ...
        resistances: variable_clone(base_resistances, true), character_key: "hero",
        battle_sprite: spr_player_battle, attack_sprite: spr_player_attack, cast_sprite: spr_player_cast, item_sprite: spr_player_item // <<< ADDED ITEM SPRITE
    });
    ...
    ds_map_add(_char_map, "claude", {
        ...
        character_key: "claude", battle_sprite: spr_claude_battle, attack_sprite: spr_claude_attack, cast_sprite: spr_claude_cast, item_sprite: spr_claude_item // <<< ADDED
    });
    ...
    ds_map_add(_char_map, "gabby", {
        ...
        battle_sprite: spr_gabby_battle, attack_sprite: spr_gabby_attack, cast_sprite: spr_gabby_cast, item_sprite: spr_gabby_item // <<< ADDED
    });

    // --- Izzy ("izzy") - Thief ---
    ds_map_add(_char_map, "izzy", {
        name: "Izzy", class: "Thief", hp: 38, maxhp: 38, mp: 15, maxmp: 15, atk: 12, def: 6, matk: 5, mdef: 4, spd: 12, luk: 10, level: 1, xp: 0, xp_require: 100, overdrive: 0, overdrive_max: 100, 
        skills: [ 
