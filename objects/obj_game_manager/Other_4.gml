...
// --- UI Layer Initialization REMOVED (Presumably handled elsewhere or via room editor) ---
...
            if (variable_struct_exists(_p_data, "hp_total")) { _player.hp_total = _p_data.hp_total; }
             // Correction based on original code pattern: assuming _p_total was a typo and it should be _p_data again
            if (variable_struct_exists(_p_data, "mp_total")) { _player.mp_total = _p_data.mp_total; } // Corrected based on pattern
