...
if (can_recruit) { // This line caused the crash if 'can_recruit' wasn't set in Create
    ...
    if (_already_in_party) {
        ...
        dialogue_data = [ { name: "izzy", msg: "Ready when you are!" } ];
        ...
        can_recruit = false;
        dialogue_data = [
             { name: "izzy", msg: "Alright, let's do this! Lead the way!" },
             { name: "System", msg: "izzy joined the party!" } // System message confirmation
        ];
