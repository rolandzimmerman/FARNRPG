/// obj_npc_recruitable_claude :: User Event 0 (Interaction)
/// Handles recruiting Claude: adds to party list AND initializes persistent stats map entry.

var _char_key = variable_instance_exists(id, "character_key") ? character_key : "claude"; 
            ...
            if (!ds_map_exists(global.party_current_stats, _char_key)) { 
                ...
                if (is_struct(_base_data)) {
                    ...
                    var _initial_stats = {
                        ...
                        def:        variable_struct_get(_base_data, "def") ?? 4, // Corrected Claude's base def
