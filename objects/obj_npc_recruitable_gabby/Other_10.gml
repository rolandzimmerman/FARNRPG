...
/// Handles recruiting gabby: adds to party list AND initializes persistent stats map entry.
            ...
            if (!ds_map_exists(global.party_current_stats, _char_key)) { 
                ...
                if (is_struct(_base_data)) {
                    ...
                    var _initial_stats = {
                        ...
                        def:        variable_struct_get(_base_data, "def") ?? 4, // Corrected gabby's base def
